...
public void open(){
		...
		if (c.isDatabaseLocal()) {
			// Use persistence.xml defaults (configured for MariaDB localhost)
			emf = Persistence.createEntityManagerFactory("iraunkortasuna");
			db = emf.createEntityManager();
		} else {
			// Override JDBC properties to connect to a remote MariaDB instance
			Map<String, String> properties = new HashMap<String, String>();
			String url = "jdbc:mariadb://"+c.getDatabaseNode()+":"+c.getDatabasePort()+"/"+fileName;
			properties.put("javax.persistence.jdbc.url", url);
			properties.put("javax.persistence.jdbc.user", c.getUser());
			properties.put("javax.persistence.jdbc.password", c.getPassword());
			emf = Persistence.createEntityManagerFactory("iraunkortasuna", properties);
			db = emf.createEntityManager();
	   	 }
